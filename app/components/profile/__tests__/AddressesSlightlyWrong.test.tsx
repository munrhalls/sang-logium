...
import { slightlyIncorrectAddresses } from "../__mocks__/AddressForm.mocks";

const TEST_COUNT = 3;

describe("Slightly Wrong Addresses (Real API)", () => {
  beforeAll(() => {
  ...
  slightlyIncorrectAddresses.slice(0, TEST_COUNT).forEach((address, index) => {
    test(`validates ${address.postcode} ${address.street} ${address.city} (slightly wrong #${index + 1})`, async () => {
