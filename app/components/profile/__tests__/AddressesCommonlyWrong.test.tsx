...
describe("Commonly Wrong Addresses (Real API)", () => {
  beforeAll(() => {
  ...
  commonlyWrongAddresses.slice(0, TEST_COUNT).forEach((address, index) => {
    test(`validates ${address.postcode} ${address.street} ${address.city} (commonly wrong #${index + 1})`, async () => {
