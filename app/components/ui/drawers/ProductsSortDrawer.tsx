...
export default function ProductsSortDrawer() {
  ...
  return (
    <div
      className={`absolute inset-y-0 right-0 lg:relative lg:h-full w-full bg-slate-900 sm:w-96 text-white shadow-xl transform ${
    ...
    >
      <div className="h-full flex flex-col">
        <header className="p-4 border-b flex justify-center items-center">
          ...
          <button onClick={toggleProductsSortDrawer} className="lg:hidden">
            <X className="h-6 w-6" />
          </button>
        </header>
