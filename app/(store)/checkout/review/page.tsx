// GET PAYMENT DATA AND DISPLAY IT IN A SECURE WAY
// GUEST? SIGN UP = CREATE ACC /W CLERK BUT THEN STRIPE ADD STRIPE CUSTOMER ID === CLERK ID + TAKE LAST PAYMENT AND ADD HIS LAST METHOD + MAKE IT DEFAULT @STRIPE -> DISPLAY TOAST CONGRATULATING ACC CREATION BUT ALSO TOAST DEFAULT PAYMENT METHOD ADDED FOR FUTURE PURCHASES

// SUMMARY OF PAYMENT
// SUMMARY OF ORDER
// THANKS
// FOOTNOTE - WANT TO SAVE TIME ON FUTURE PURCHASES BY SAVING YOUR PAYMENT METHOD? SIGN UP IN 30 SECONDS
