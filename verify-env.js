...
if (missing.length > 0) {
  console.error(
    "\x1b[31mError: Missing essential environment variables:\x1b[0m",
    missing.join(", "),
  );
  console.log(
    "\x1b[33mThese variables must be set in .env.production or in Netlify environment settings.\x1b[0m",
  );
  process.exit(1);
} else {
